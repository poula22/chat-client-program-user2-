...
import clientconnection.ClientHandler;
 ...
 * @author george
 */
public class ClientConnectionFrame extends javax.swing.JFrame {

    /**
     * Creates new form ClientConnectionFrame
     */
    ...
    public ClientConnectionFrame() {
        try {
            ...
            c=new ClientHandler(client, jTextField1, jTextArea1);
            t=new Thread(c);
            t.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientConnectionFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
